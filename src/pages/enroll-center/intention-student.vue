...
import allIntentionStudent from '~@/components/enroll-center/all-intention-student.vue';
...
<template>
  <div class="home">
    <div class="tabs">
      <a-tabs v-model:activeKey="activeKey" :tabBarStyle="{
        'border-bottom-left-radius': '0px',
        'border-bottom-right-radius': '0px'
      }">
        <!-- force-render 强制渲染 -->
        <a-tab-pane key="1" tab="意向学员">
          <a-tabs v-model:activeKey="activeKey2" :tabBarStyle="{
            'height': '46px', 'border-top-left-radius': '0px',
            'border-top-right-radius': '0px'
          }" class="twoTab">
            <a-tab-pane key="1" tab="全部意向学员">
              <div class="tab-content">
                <all-intention-student></all-intention-student>
                <div class="tab-table">
                  <div class="table-title flex justify-between">
                    ...
                    <div class="edit flex">
                      ...
                      <customize-code v-model:checkedValues="selectedValues" :options="columnOptions"
                        :total="allColumns.length - 2" :num="selectedValues.length - 1" />
                    </div>
                  </div>
                            ...
                            <a-dropdown :trigger="['click']" v-model:open="visible">
                              <div @click.prevent>
                                <div class="intention">
                                  ...
                                  <CaretDownOutlined v-if="!visible" class="ml-1 text-#ccc"
                                    :style="{ 'font-size': '10px' }" />
                                  <CaretUpOutlined v-if="visible" class="ml-1 text-#1677ff"
                                    :style="{ 'font-size': '10px' }" />
                                </div>
                              </div>
                              <template #overlay>
                              ...
                              <a-dropdown :trigger="['click']" v-model:open="actionvisible">
                                <a @click.prevent>
                                  <div class="intention">更多
                                    ...
                                    <CaretUpOutlined v-if="actionvisible" class="ml-1 text-#ccc"
                                      :style="{ 'font-size': '12px' }" />
                                  </div>
                                </a>
                                <template #overlay>
        ...
        <a-tab-pane key="2" tab="公有池">公有池</a-tab-pane>
        <a-tab-pane key="3" tab="渠道管理">渠道管理</a-tab-pane>
