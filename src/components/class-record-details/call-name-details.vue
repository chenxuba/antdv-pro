  ...
  <div>
    ...
    <div class="filter-wrap bg-white  pl-3 pr-3 rounded-4">
      <all-filter :defaultStudentStatus="defaultStudentStatus" :displayArray="displayArray" :is-quick-show="false"
        :is-show-search-input="true" search-label="学员姓名"></all-filter>
    </div>
    <div class="student-list mt-3 pt-3 pb-3 pl-6 pr-6 bg-white rounded-4">
      <div class="tab-table">
        <div class="table-title flex justify-between">
          <div class="total">共 <span class="text-4 mx-2 text-#06f">{{ dataSource.length }}</span> 条记录</div>
        </div>
          ...
          <a-table :dataSource="dataSource" :pagination="dataSource.length > 10" :columns="filteredColumns"
            ...
            <template #headerCell="{ column }">
              <template v-if="column.key === 'courseNotMethod'">
                ...
                <a-popover placement="top">
                  <template #title>
                    <div style="border-bottom:1px solid #eee;padding-bottom: 6px;">课消方式</div>
                  </template>
                  <template #content>
              ...
              <template v-if="column.key === 'useNum'">
                ...
                <a-popover placement="top">
                  <template #title>
                    <div style="border-bottom:1px solid #eee;padding-bottom: 6px;">消耗数量</div>
                  </template>
                  <template #content>
              ...
              <template v-if="column.key === 'oweNum'">
                ...
                <a-popover placement="top">
                  <template #title>
                    <div style="border-bottom:1px solid #eee;padding-bottom: 6px;">拖欠数量</div>
                  </template>
                  <template #content>
              ...
              <template v-if="column.key === 'usePrice'">
                ...
                <a-popover placement="top">
                  <template #title>
                    <div style="border-bottom:1px solid #eee;padding-bottom: 6px;">消耗学费</div>
                  </template>
                  <template #content>
            ...
            <template #bodyCell="{ column, record }">
              ...
              <template v-if="column.key === 'name'">
                <a-tooltip>
                  <template #title>查看学员档案{{ record.a }}</template>
              ...
              <template v-if="column.key === 'detail'">
                <a-tooltip>
                  <template #title>学员点名详情{{ record.a }}</template>
