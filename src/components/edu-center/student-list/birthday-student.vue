    ...
    <div class="student-list mt-2 pt-3 pb-3 pl-6 pr-6 bg-white rounded-4">
      <div class="tab-table">
        ...
        <div class="table-content mt-2">
          <a-table :dataSource="dataSource" :pagination="dataSource.length>10" :columns="filteredColumns" :scroll="{ x: totalWidth }" size="small">
            <template #bodyCell="{ column, record }">
              ...
              <template v-if="column.key === 'action'">
                <a-space>
                  <a-button type="link" size="small">去分班</a-button>
                </a-space>
              </template>
            </template>
          </a-table>
