<template>
  <div class="bg-white h-82vh flex justify-center flex-items-center pb-60">
    ...
    <div
      ...
      <div class="text-4 text-#222 font-500 mb-1">人脸考勤</div>
      <div class="text-3 text-#222">识别自动记录，支持多人识别</div>
    </div>
    <div
      ...
      <img width="73" height="73" class="mb-2"
        src="https://prod-tbu-next-erp-cdn.schoolpal.cn/next-pc-static/static/12087/static/more-dian-icon.4505caef.png"
        alt="">
      <div class="text-4 text-#222 font-500 mb-1">人脸考勤设备</div>
      <div class="text-3 text-#06f">未激活设备，点此激活 > </div>
    </div>
